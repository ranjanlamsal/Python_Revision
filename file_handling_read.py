...
print(f.readline(5))
#when argument (integer) is passed in .readline() attribute then upto given index(arg) is only read from the location of pointer


print(f.readlines())
#readlines attribute read all the lines in file and store them in a list object
